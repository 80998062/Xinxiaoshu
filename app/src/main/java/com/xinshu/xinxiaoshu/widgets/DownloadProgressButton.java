package com.xinshu.xinxiaoshu.widgets;
...
public class DownloadProgressButton extends TextView {
    ...
    private float background_strokeWidth;//边框宽度
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mBackgroundColor = a.getColor(R.styleable.DownloadProgressButton_backgroud_color, getResources().getColor(R.color.theme_cyan));
        mBackgroundSecondColor = a.getColor(R.styleable.DownloadProgressButton_backgroud_second_color, getResources().getColor(R.color.theme_cyan));
        mButtonRadius = a.getFloat(R.styleable.DownloadProgressButton_radius, 0);

        mTextColor = a.getColor(R.styleable.DownloadProgressButton_text_color, getResources().getColor(R.color.text_color_grey));

        mTextCoverColor = a.getColor(R.styleable.DownloadProgressButton_text_covercolor, Color.WHITE);

        background_strokeWidth = a.getDimension(R.styleable.DownloadProgressButton_backgroud_strokeWidth, 2.5F);
    ...
    private void init() {
        ...
        mProgress = 0;
        if (mNormalText == null) {
            mNormalText = getResources().getString(R.string.action_upload);
        }
        if (mDowningText == null) {
            mDowningText = "";
        }
        if (mFinishText == null) {
            mFinishText = getResources().getString(R.string.action_upload_succeed);
        }
        if (mPauseText == null) {
            mPauseText = getResources().getString(R.string.action_upload_resume);
        }
        //设置背景画笔
...
//            }
        ...
        switch (mState) {
            ...
            case PAUSE:
                ...
                LinearGradient mProgressBgGradient = new LinearGradient(background_strokeWidth,
                        0, getMeasuredWidth() - background_strokeWidth, 0,
        ...
        switch (mState) {
            ...
            case PAUSE:
                ...
                if (coverlength <= indicator1) {
                    ...
                    LinearGradient mProgressTextGradient = new LinearGradient((w - textWidth) / 2 + background_strokeWidth, 0,
