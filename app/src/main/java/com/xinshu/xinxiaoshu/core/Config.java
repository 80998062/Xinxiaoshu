...
public class Config {
    ...
    final static public String EXT_DIR = Environment.getExternalStorageDirectory() + "/Xinxiaoshu";

    final static public String DATA_DIR = Environment.getDataDirectory() + "/data/com.xinshu.xinxiaoshu";
