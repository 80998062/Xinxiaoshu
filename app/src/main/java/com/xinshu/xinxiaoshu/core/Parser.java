...
import com.xinshu.xinxiaoshu.models.Comment;
import com.xinshu.xinxiaoshu.models.Like;
...
public class Parser {
    ...
    private Class SnsDetailParser;
    private Class SnsDetail;
    private Class SnsObject;

    public Parser() {
        throw new RuntimeException("创建Parser失败");
    }
    ...
    SnsInfo parseSnsAllFromBin(byte[] snsDetailBin, byte[] snsObjectBin) throws Throwable {
    ...
    private Object parseSnsDetailFromBin(byte[] bin) throws Throwable {
    ...
    private SnsInfo parseSnsDetail(Object snsDetail) throws Throwable {
    ...
    private Object parseSnsObjectFromBin(byte[] bin) throws Throwable {
    ...
    private static SnsInfo parseTimelineXML(String xmlResult) throws Throwable {
    ...
    private static void parseSnsObject(Object aqiObject, SnsInfo matchSns) throws Throwable {
        Field field = null;
    ...
    private static void parseSnsObjectExt(Object apzObject, boolean isComment, SnsInfo matchSns) throws Throwable {
        if (isComment) {
            ...
            for (int i = 0; i < matchSns.comments.size(); i++) {
                Comment loadedComment = matchSns.comments.get(i);
    ...
    private static String getTimelineId(String xmlResult) {
